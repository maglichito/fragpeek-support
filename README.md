...
### 1. Why is there no "Create Account" option?
Fragpeek is a dedicated client for the FACEIT platform. To ensure your stats, ranks, and match history are accurate and secure, we use **FACEIT Connect** for authentication. You must have an existing account at [FACEIT.com](https://www.faceit.com) to use the app.
...
If you encounter a bug, a crash, or have a feature request to make Fragpeek better, we want to hear from you!

* **Email:** [developer.dzenan@gmail.com](mailto:developer.dzenan@gmail.com)
* **Response Time:** We aim to respond to all support inquiries within 24–48 hours.

> **Note:** For issues regarding banned accounts, Elo adjustments, or platform-wide FACEIT outages, please contact [FACEIT Support](https://support.faceit.com/hc/en-us) directly.
